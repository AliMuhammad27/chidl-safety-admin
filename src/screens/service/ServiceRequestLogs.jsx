            ...
            <section id="configuration">
              <div className="d-flex align-items-center justify-content-between text-center flex-wrap">
                ...
                <div className="text-center">
                  <Link to="/services" className="prim-btn cmsbtnPrim mb-4">
                    Services
                  </Link>
                </div>
              </div>
                                    ...
                                    <div className="btn-group">
                                      ...
                                      <div className="dropdown-menu text-left custom-dropdown">
                                        <a
                                          ...
                                          href="./acceptedServiceDetails.php"
                                        >
                                  ...
                                  <td>
                                    <div className="btn-group">
                                      ...
                                      <div className="dropdown-menu text-left custom-dropdown">
                                        <a
                                          className="dropdown-item"
                                          href="./completedServiceRequests.php"
                                        >
                                          <i className="far fa-eye" />
                                          View
                                        </a>
                                  ...
                                  <td>
                                    <div className="btn-group">
                                      ...
                                      <div className="dropdown-menu text-left custom-dropdown">
                                        <a
                                          className="dropdown-item"
                                          href="./rejectedServiceDetails.php"
                                        >
                                          <i className="far fa-eye" />
                                          View
                                        </a>
                                  ...
                                  <td>
                                    <div className="btn-group">
                                      ...
                                      <div className="dropdown-menu text-left custom-dropdown">
                                        <a
                                          className="dropdown-item"
                                          href="./pendingServicesDetails.php"
                                        >
                                          <i className="far fa-eye" />
                                          View
                                        </a>
